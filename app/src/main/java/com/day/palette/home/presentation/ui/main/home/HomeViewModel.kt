...
import com.day.palette.home.domain.usecase.GetAllCountriesUseCase
import com.day.palette.home.domain.usecase.GetCountryHolidaysUseCase
import com.day.palette.home.domain.usecase.GetSelectedCountryDetailsUseCase
import com.day.palette.home.domain.usecase.SetSelectedCountryDetailsUseCase
...
import com.day.palette.common.presentation.utils.asUiText
...
class HomeViewModel @Inject constructor(
    ...
    private val initialState = savedStateHandle[VIEW_MODEL_STATE] ?: HomeState()
