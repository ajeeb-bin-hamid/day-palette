...
import com.day.palette.home.domain.usecase.GetWorldWideHolidaysUseCase
...
class ExploreViewModel @Inject constructor(
    ...
    private val initialState = savedStateHandle[VIEW_MODEL_STATE] ?: ExploreState(
        holidays = ArrayList()
    )
    ...
    fun invoke(action: ExploreIntent) {
        when (action) {
