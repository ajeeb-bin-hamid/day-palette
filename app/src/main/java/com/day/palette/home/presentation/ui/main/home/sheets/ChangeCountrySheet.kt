package com.day.palette.home.presentation.ui.main.home.sheets
...
import com.day.palette.home.presentation.ui.main.home.HomeIntent
import com.day.palette.home.presentation.ui.main.home.HomeState
import com.day.palette.home.presentation.ui.main.home.HomeViewModel
...
import com.day.palette.common.presentation.utils.onTextChanged
...
class ChangeCountrySheet : BottomSheetDialogFragment() {
    ...
    private fun setUpRecyclerView() {
        recyclerAdapter = ChangeCountryRecyclerAdapter(requireContext(), ArrayList()).apply {
            setOnItemClickListener { _, country, type, _ ->
                when (type) {
