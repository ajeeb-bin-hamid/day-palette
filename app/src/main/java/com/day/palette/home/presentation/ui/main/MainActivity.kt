...
import com.day.palette.home.presentation.ui.main.explore.ExploreFragment
import com.day.palette.home.presentation.ui.main.home.HomeFragment
import com.day.palette.home.presentation.ui.main.memories.MemoriesFragment
import com.day.palette.common.presentation.utils.INSTANCE_BOTTOM_BAR_SELECTED_ITEM
...
class MainActivity : AppCompatActivity() {
    ...
    private fun observeSideEffect(action: MainSideEffect) {
        when (action) {
            is MainSideEffect.ShowToast -> this.showToast(action.message)
            is MainSideEffect.ShowSnack -> this.showSnack(b.root, action.message)
        }
    }
